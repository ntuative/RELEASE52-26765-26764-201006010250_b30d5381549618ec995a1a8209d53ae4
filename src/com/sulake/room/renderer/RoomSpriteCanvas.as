package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1456:int = 50;
      ...
      private var var_1916:Number = -1.0E7;
      
      private var var_1914:Number = -1.0E7;
      ...
      private var var_1035:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_1037 == 0)
         {
            checkMouseHits(var_1036.x,var_1036.y,MouseEvent.MOUSE_MOVE);
         }
         var_1037 = 0;
         ++var_1511;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_53.graphics.beginFill(var_2397);
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_718 != var_1913 || var_719 != var_1917)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
         ...
         if(_loc5_ < var_421.length)
         {
            var_421.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = var_421[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         while(_loc1_ < var_301.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1035 != null)
                  {
                     var_1035.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1511,geometry);
                  }
                  else
                  {
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_514.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_514.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1916 || param2 != var_1914)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_514.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_514.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc13_ += int(var_718 / 2);
         _loc14_ += int(var_719 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_718 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_719))
                  {
