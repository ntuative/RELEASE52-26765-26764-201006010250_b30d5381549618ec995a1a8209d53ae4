package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private const const_1460:String = "fuselogin";
      
      public var name:String = "";
      
      private var _window:IWindowContainer;
      
      private var var_180:HabboCommunicationDemo;
      ...
      {
         var_180.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_180.shockwaveClientUrl = var_116.shockwaveClientUrl;
         var_180.ssoTicket = var_116.ticket;
         var_116.removeEventListener(SSOTicket.const_337,onParsedTicketSuccess);
         var_116.removeEventListener(SSOTicket.const_263,onParsedTicketFailure);
         var_116 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1460,"/");
      ...
      {
         var _loc8_:* = null;
         var _loc1_:XmlAsset = (var_180 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_180.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_113,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_180.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1460,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_180.habboConfiguration.getKey("use.sso","false") == "HabboNavigatorCom_ros_flat_controller_xml")
            {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_180.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_180.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_180.habboCommunication.habboWebLogin(name,password);
         var_116 = new SSOTicket(var_180.assets,_loc2_,_loc1_);
         var_116.addEventListener(SSOTicket.const_337,onParsedTicketSuccess);
         var_116.addEventListener(SSOTicket.const_263,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_180.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_180.windowManager.buildFromXML(_loc3_.content as XML);
