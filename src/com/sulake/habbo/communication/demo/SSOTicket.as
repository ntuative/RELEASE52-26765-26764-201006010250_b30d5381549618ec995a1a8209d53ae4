package com.sulake.habbo.communication.demo
{
   ...
   public class SSOTicket extends EventDispatcher
   {
      ...
      public static const const_337:String = "success";
      ...
      private var var_1385:IHabboWebLogin;
      ...
      public function SSOTicket(param1:IAssetLibrary, param2:IHabboWebLogin, param3:String)
      {
         ...
         _assets = param1;
         var_1385 = param2;
         var_1384 = "http://" + param3 + "/client";
         var_1385.init();
         var_1385.addEventListener(HabboWeb.const_229,requestClientURL);
      }
      ...
      {
         var _loc2_:String = var_1384;
         if(_assets.hasAsset(_loc2_))
         {
            Logger.log("[CoreLocalizationManager] reload localization for url: " + var_1384);
         }
         var _loc3_:URLRequest = new URLRequest(var_1384);
         if(_assets.hasAsset(_loc2_))
         {
      ...
      private function clientURLComplete(param1:Event = null) : void
      {
         ...
         {
            var_1385.requestReAuthenticate();
         }
         else
         {
            try
            {
               var_1618 = /\"sso.ticket\" : \"(.*?)\"/.exec(data)[1];
               var_2238 = /\"flash.client.url\" : \"(.*?)\"/.exec(data)[1];
               if(false)
               {
