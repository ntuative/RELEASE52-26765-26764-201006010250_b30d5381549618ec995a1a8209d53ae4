package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1949:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1520:ILogger;
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         if(var_1045)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_192);
         }
         var_1951 = true;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1951)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_725 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_725);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1263,var_1950));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1460,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1949);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1460,"/");
      ...
      {
         var_725 = _habboConfiguration.getKey("sso.ticket",null);
         var_1263 = _habboConfiguration.getKey("flash.client.url","");
         ...
         if(var_725 != null)
         {
            var_59.mode = HabboConnectionType.const_469;
            var_59.initConnection(HabboConnectionType.const_269);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1520 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_693);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1949 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_59.mode)
         {
            case HabboConnectionType.const_469:
               ...
               break;
            case HabboConnectionType.const_982:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1276:
               var_606 = generateRandomHexString(30);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_59.mode = HabboConnectionType.const_982;
            }
         }
         var_59.initConnection(HabboConnectionType.const_269);
      }
