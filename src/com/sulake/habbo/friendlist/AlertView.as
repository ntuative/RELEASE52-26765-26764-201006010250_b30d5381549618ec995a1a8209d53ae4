package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1329));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1576[var_1329]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
