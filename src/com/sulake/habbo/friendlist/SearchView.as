package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_679 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_679.procedure = onSearchInput;
         var_679.addEventListener(WindowKeyboardEvent.const_154,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_50.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_323,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_679.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
