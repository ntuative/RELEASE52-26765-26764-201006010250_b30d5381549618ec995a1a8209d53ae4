package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      {
         var_1942 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1940 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1943 = initButton("room_invite",onInviteButtonClick,param1);
         var_1941 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1942,isEnableMinimailButton(_loc1_));
         setEnabled(var_1940,isEnableHomeButton(_loc1_));
         setEnabled(var_1943,isEnableInviteButton(_loc1_));
         setEnabled(var_1941,isEnableRemoveButton(_loc1_));
      }
