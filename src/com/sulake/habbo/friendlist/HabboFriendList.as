package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_2019:FriendListLookAndFeel;
      ...
      {
         var_2019 = new FriendListLookAndFeel();
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_359.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_359.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_420.findTab(FriendListTab.const_87).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_359 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_90.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_90.addCategory(new FriendCategory(FriendCategory.const_901,getText("friendlist.friends")));
         var_90.addCategory(new FriendCategory(FriendCategory.const_388,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_527)
         {
            var_527 = new Timer(120000);
            var_527.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_527.start();
         }
         getBuddyRequests();
         registerListeners();
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_527.stop();
            var_527.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_527 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_894)
         {
            var_894.release(new IIDAvatarRenderManager());
            var_894 = null;
         }
         if(var_893)
         {
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "HabboNavigatorCom_ros_flat_controller_xml";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_335));
            }
            else
            {
               switch(_loc1_.id)
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_193,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_359.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ > var_359.limit)
         {
            var_359.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_420.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_894.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_359.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_420.findTab(FriendListTab.const_87);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_894 = param2 as IAvatarRenderManager;
      ...
      private function registerListeners() : void
      {
         ...
         _communication.addHabboConnectionMessageEvent(new RoomInviteErrorEvent(method_10));
