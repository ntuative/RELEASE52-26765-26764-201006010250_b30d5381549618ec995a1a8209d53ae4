package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1308 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_865 = IWindowContainer(var_15.content.findChildByName("main_content"));
         var_266 = IWindowContainer(var_15.content.findChildByName("footer"));
         var_1308.prepare(var_865);
         var_15.procedure = onWindow;
         var_15.content.setParamFlag(HabboWindowParam.const_840,false);
         var_15.content.setParamFlag(HabboWindowParam.const_1430,true);
         var_15.header.setParamFlag(HabboWindowParam.const_588,false);
         var_15.header.setParamFlag(HabboWindowParam.const_1046,true);
         var_15.content.setParamFlag(HabboWindowParam.const_588,false);
         var_15.content.setParamFlag(HabboWindowParam.const_1046,true);
         var_15.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1309 = ITextWindow(var_15.findChildByName("info_text"));
         var_1309.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_15.scaler.setParamFlag(HabboWindowParam.const_946,this._friendList.tabs.findSelectedTab() != null);
         var_15.scaler.setParamFlag(HabboWindowParam.const_588,false);
         var_15.scaler.setParamFlag(HabboWindowParam.const_840,false);
         var_15.scaler.x = 0 - var_15.scaler.width;
         var_15.scaler.y = 0 - var_15.scaler.height;
         var_1567 = var_15.height;
         var_1568 = var_15.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1567 == -1 ? 0 : int(0 - var_1567);
         var _loc4_:int = var_1568 == -1 ? 0 : int(0 - var_1568);
