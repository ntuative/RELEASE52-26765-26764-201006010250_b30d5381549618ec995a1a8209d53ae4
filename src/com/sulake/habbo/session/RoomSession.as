package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      {
         if(var_36 == RoomSessionEvent.const_313 && _connection != null)
         {
            var_36 = RoomSessionEvent.const_100;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1079 as IUserDataManager;
      }
