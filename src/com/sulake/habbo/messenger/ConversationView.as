package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_796:int = 100;
      ...
      private var var_1566:IContainerButtonWindow;
      
      private var var_532:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_128 = param1;
         var_1566 = initButton("follow_friend",onFollowButtonClick,param2);
         var_50 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2067 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_717 || param3.type == Message.const_653 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_532.messages.length - const_796);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_532.messages.length)
         {
            refreshEntry(true,_loc1_,var_532.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_532 == null || _loc1_.id != var_532.id)
         {
            var_532 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_796 + const_1144)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_128.send(new FollowFriendMessageComposer(var_532.id));
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1143;
         param1.invalidate();
      }
   }
}
