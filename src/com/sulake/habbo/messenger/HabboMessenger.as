package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_617:Conversations;
      ...
      {
         var _loc2_:Conversation = var_617.addConversation(param1);
         if(_loc2_ == null)
         {
      ...
      {
         var_617.addMessageAndUpdateView(param1);
      ...
      {
         var_617 = new Conversations(new ConversationsDeps(this));
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_162,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.MESSENGER));
         var _loc3_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_193,HabboToolbarIconEnum.MESSENGER);
      ...
      {
         var_617.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         var_617.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var_617.addMessageAndUpdateView(_loc3_);
      }
