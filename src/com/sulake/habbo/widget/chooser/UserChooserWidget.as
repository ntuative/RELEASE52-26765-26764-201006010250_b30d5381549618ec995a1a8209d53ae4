package com.sulake.habbo.widget.chooser
{
   ...
   public class UserChooserWidget extends ChooserWidgetBase
   {
      ...
      private const const_1471:int = 1;
      
      private const const_1739:int = 0;
      ...
      private function method_7(param1:RoomWidgetChooserContentEvent) : void
      {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_684,method_7);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_266,onUpdateUserChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_576,onUpdateUserChooser);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_684,method_7);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_266,onUpdateUserChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_576,onUpdateUserChooser);
      }
