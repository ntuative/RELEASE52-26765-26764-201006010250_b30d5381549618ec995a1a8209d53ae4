package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1718:uint = 6710886;
      ...
      private const const_1713:String = "energy";
      
      private var var_1185:Map;
      
      private const const_1714:String = "nutrition";
      
      private var var_63:IItemListWindow;
      
      private const const_1719:uint = 3355443;
      
      private var var_220:IBorderWindow;
      
      private const const_1717:int = 158;
      
      private const const_1715:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_171:PetCommandTool;
      
      private const const_1716:uint = 11184810;
      
      private const const_1712:String = "experience";
      ...
      {
         if(var_102 == null || var_220 == null || var_63 == null)
         {
            return;
         }
         ...
         var_220.height = NaN;
         _window.width = Math.max(var_220.width,var_63.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1185.getValue(var_645) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1712,param1.experience,param1.experienceMax);
         updateStateElement(const_1713,param1.energy,param1.energyMax);
         updateStateElement(const_1714,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_645 = param1.id;
         var_1185.remove(param1.id);
         var_1185.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_171 && var_171.getPetId() == var_645)
               {
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1717,const_1715,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1716);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1719);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1718);
         return _loc5_;
      }
