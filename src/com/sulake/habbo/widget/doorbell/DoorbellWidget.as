package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_582,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_133,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_582,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_133,onDoorbellHandled);
