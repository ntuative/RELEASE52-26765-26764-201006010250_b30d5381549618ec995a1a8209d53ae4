package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_372:int = 10;
      
      private static const const_1162:Number = 18;
      ...
      {
         _widget.onItemMouseOut(var_1107,var_1109,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1107,var_774,var_1109,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1377 = param1.chatType;
         var_1107 = param1.userId;
         var_774 = param1.userName;
         var_1109 = param1.userCategory;
         _message = param1.text;
         var_1378 = param1.userX;
         var_208 = param1.userImage;
         var_1108 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_208 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_452 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1108 != 0)
            {
               _loc30_ = uint(var_1108 >> 16 & 255);
               _loc31_ = uint(var_1108 >> 8 & 255);
               _loc32_ = uint(var_1108 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_372;
            }
            else
            {
               _loc19_.text = var_774 + ":";
               _loc19_.y += var_452;
               _loc19_.width = _loc19_.textWidth + const_372;
               _width += _loc19_.textWidth + const_372;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1377 == RoomWidgetChatUpdateEvent.const_249)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_774);
            }
            else if(var_1377 == RoomWidgetChatUpdateEvent.const_271)
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_372 + _loc20_.textWidth + const_525;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1107,var_1109,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1107,var_1109,_roomId,_roomCategory,param1);
      }
