package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_437.destroyGridItems();
         var_305 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1300) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_898.width,var_898.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_737.width,var_737.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_737,var_737.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_437.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_437.numGridItems)
         {
            return;
         }
         select(var_437.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_898 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         var_737 = BitmapData(_loc3_.content);
      }
