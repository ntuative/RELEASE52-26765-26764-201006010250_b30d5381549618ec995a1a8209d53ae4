package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1223:XML;
      
      private var _selectedColorIndex:int;
      
      private var var_502:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_57,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1067,const_1066,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_502 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_502 != null)
         {
            var_502.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1023 = _loc2_.light;
         if(var_342 != null)
         {
            var_342.setValue(var_1023);
         }
         _selectedColorIndex = colors.indexOf(_loc2_.color);
         if(var_502 != null)
         {
            var_502.setSelectedColorIndex(_selectedColorIndex);
         }
