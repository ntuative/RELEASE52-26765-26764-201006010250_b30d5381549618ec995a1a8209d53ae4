package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_685:MeMenuSettingsViewSlider;
      
      private var var_1452:BitmapData;
      
      private var var_1453:BitmapData;
      
      private var var_686:Number = 1.0;
      ...
      {
         var_686 = param1.volume;
         if(var_685 != null)
         {
            var_685.setValue(var_686);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_685 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_580));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_686 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1451);
               }
               break;
            case "sounds_on":
               if(var_686 != 1)
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1450);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1451);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1452);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1453);
