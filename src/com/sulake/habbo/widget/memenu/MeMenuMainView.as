      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "wave":
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_956));
            ...
            case "clothes":
               ...
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1015));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_646);
               break;
            case "news":
               if(false && false)
               {
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","false") == "HabboNavigatorCom_ros_flat_controller_xml";
               if(false && _loc4_)
               {
