package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_738[var_1071] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_307)
         {
            ...
            var_307 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_307.center();
            var_307.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1071;
         if(var_1071 < var_738.length)
         {
            _loc1_ = var_738[var_1071] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_738.length);
                  _loc2_.text = _loc6_;
               }
