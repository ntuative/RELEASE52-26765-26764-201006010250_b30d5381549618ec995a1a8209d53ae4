package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_875:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            ...
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_465,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_47.getValue(InventoryCategory.const_575));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_47.getValue(InventoryCategory.const_81));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1040));
      }
      ...
      {
         return AchievementsModel(var_47.getValue(InventoryCategory.const_329));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_876.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_876.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_47.getValue(InventorySubCategory.const_294));
      }
      ...
      {
         return var_47.getValue(InventoryCategory.const_331) as MarketplaceModel;
      }
      ...
      {
         return BadgesModel(var_47.getValue(InventoryCategory.const_284));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_465,roomSessionEventHandler);
         ...
         var_47.add(InventoryCategory.const_331,_loc3_);
