package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_575);
         _loc2_.refreshViews();
         var_11.notifyChangedEffects();
      }
      ...
      {
         var _loc2_:* = null;
         if(var_11.isInventoryCategoryInit(InventoryCategory.const_331))
         {
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_11.setInventoryCategoryInit(InventoryCategory.const_329);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_11.toggleInventorySubPage(InventorySubCategory.const_294);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_11.setInventoryCategoryInit(InventoryCategory.const_284);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_11.setInventoryCategoryInit(InventoryCategory.const_331);
         var _loc4_:FurniModel = var_11.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
