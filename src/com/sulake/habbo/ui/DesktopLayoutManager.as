package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_52.getChildByTag(const_1065) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_52.findChildByTag(const_1065) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
