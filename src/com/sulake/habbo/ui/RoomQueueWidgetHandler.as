package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_546);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_701);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_1035);
               break;
            case RoomWidgetRoomQueueMessage.const_546:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_951);
               break;
            case RoomWidgetRoomQueueMessage.const_701:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_237,true);
               }
         }
         return null;
      }
