package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_97:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_286:
               _container.events.dispatchEvent(param1);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(AdEvent.const_385);
         _loc1_.push(AdEvent.const_504);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_97);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_286);
         return _loc1_;
      }
