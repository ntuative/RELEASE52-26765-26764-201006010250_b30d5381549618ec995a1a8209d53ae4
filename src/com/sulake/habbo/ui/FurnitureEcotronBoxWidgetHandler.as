package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_652,RoomWidgetEcotronBoxOpenMessage.const_718,RoomWidgetEcotronBoxOpenedMessage.const_1300];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_652:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_718:
