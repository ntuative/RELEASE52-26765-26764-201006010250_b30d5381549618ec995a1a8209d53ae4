package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_806:Number = 0.0;
      
      private var var_467:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_335 != null)
         {
            ...
            {
               _loc2_ = var_335.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_335.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_669.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_334:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_335.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_669.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_730,RoomWidgetChatSelectAvatarMessage.const_589];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_730:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_152,_container.roomSession,0,"Version 26765-26764-201006010238");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_589:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_806 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_806);
            }
            if(var_467 == null)
            {
               var_466.x = 0;
               var_466.y = 0;
               var_466.z = 0;
               var_467 = _loc4_.getScreenPoint(var_466);
               var_806 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_466.x = 0;
            var_466.y = 0;
            var_466.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_466);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_467.x || _loc8_.y != var_467.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_467,_loc5_));
