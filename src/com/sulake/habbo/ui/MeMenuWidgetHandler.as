   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_907,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_638,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_424,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_638,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_187,onCreditBalance);
         }
         var_11 = _container.inventory;
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1040,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_930,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_424,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_424:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_489));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetGetEffectsMessage.const_559);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_710);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_601);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_608);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_737);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_686);
         ...
         _loc1_.push(RoomWidgetToolbarMessage.const_712);
         _loc1_.push(RoomWidgetToolbarMessage.const_633);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_306);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1314);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1034);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_554);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_706);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_580);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1183);
         ...
         _loc1_.push(RoomWidgetClothingChangeMessage.const_318);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetDanceMessage.const_703:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_559:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_710:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_601:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_686:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1015)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_237,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_737:
               ...
               if(var_11 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     ...
                     case RoomWidgetOpenInventoryMessage.const_926:
                        var_11.toggleInventoryPage(InventoryCategory.const_284);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1257:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_608:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1018:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1400:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1043:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_554:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_712:
               ...
               if(var_195)
               {
                  var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_633:
               ...
               if(var_195 && false)
               {
                  var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_510,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_306:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_580:
            ...
            case RoomWidgetAvatarEditorMessage.const_674:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_414));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_318:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_669));
               break;
            default:
