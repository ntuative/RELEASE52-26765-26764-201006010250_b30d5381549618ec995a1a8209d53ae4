package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_538 = new Timer(100);
         var_538.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
         ...
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_56,540,"t"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_56,512,"w"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_56,396,"x"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_56,440,"y"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_56,456,"z"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_56,208,"0"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1083 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_538)
         {
            var_538.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_538.reset();
            var_538 = null;
         }
      }
      ...
      {
         var_1083.goBackToInitialState();
         var_1083.input.textBackgroundColor = 4294967295;
         var_911 = var_40[0];
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1083.getText();
      ...
      {
         var _loc1_:Boolean = var_1083.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!var_1326 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1326 = true;
            _loc3_.y = 1;
