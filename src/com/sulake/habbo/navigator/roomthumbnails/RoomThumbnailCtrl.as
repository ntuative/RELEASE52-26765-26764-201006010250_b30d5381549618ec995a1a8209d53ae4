package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1487,this._model.mode != ThumbnailEditorModel.const_58);
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1855 = IWindowContainer(find("tile_grid"));
         var_1856 = IWindowContainer(find("now_editing_container"));
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1855;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_437)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1856;
