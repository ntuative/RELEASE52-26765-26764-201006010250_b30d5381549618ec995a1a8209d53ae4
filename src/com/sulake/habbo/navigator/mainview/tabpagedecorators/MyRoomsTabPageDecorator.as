package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_547:IDropMenuWindow;
      ...
      {
         var _loc1_:int = var_547 == null ? 0 : int(var_547.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_547 == null)
         {
            var_547 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_547.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
