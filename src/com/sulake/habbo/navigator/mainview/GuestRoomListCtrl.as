package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_850:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         var_850 = new UserCountRenderer(_navigator);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1295 != null)
         {
            _loc2_ = var_1295.tags[0];
            var_1295.color = getBgColor(_loc2_);
         }
         var_1295 = param1;
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(var_2026 - _loc2_.stageX);
         var_2026 = _loc2_.stageX;
         var_2025 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_175,null,0);
         ...
         var_850.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1367,true);
