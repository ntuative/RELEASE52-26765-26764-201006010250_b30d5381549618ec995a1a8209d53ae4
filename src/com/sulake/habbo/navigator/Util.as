package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1591:CutToHeight = new CutToHeight();
      
      private static var var_1590:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1591.beforeSearch(param2,param1,param3);
         binarySearch(var_1591,param2.length - 1);
      }
