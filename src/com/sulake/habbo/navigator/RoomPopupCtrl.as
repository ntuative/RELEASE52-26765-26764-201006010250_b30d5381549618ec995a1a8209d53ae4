package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2137 = new RoomThumbnailRenderer(param1);
         var_946 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_184,var_118.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_946.refreshTags(_loc1_,var_118.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2137.refreshThumbnail(_loc1_,var_118.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_184,var_118);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_184,!true ? getEventCtg(var_118.categoryId) : getRoomCtg(var_118.categoryId));
         refreshRoomDesc(var_184,var_118);
         refreshExtraCont();
         refreshInfo(var_184,"trading_allowed",var_118.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_235,Tabs.const_238,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
