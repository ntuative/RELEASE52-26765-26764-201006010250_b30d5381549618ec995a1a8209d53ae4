   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_898 / _loc3_.state;
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            var_1497.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),var_1497).length > 0)
            {
               if(object.getState(0) != const_790)
               {
                  object.setState(const_790,0);
               }
            }
            else
            {
