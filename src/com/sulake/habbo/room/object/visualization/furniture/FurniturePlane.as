package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         var_626 = new Vector3d();
         var_626.assign(param2);
         var_627 = new Vector3d();
         var_627.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2131)
         {
            if(!param1)
            {
               var_282.assign(var_626);
               var_281.assign(var_627);
            }
            else
            {
               var_282.assign(var_626);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_70 == null && var_927 != null || var_282 == null || var_281 == null || var_541 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1342)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1092 || _loc4_.y != var_2130 || _loc4_.z != var_2134 || param1.scale != var_2132))
            {
               var_1092 = _loc4_.x;
               var_2130 = _loc4_.y;
               var_2134 = _loc4_.z;
