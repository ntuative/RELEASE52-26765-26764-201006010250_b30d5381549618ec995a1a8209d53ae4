package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1020:Point = null;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1021 = param1;
         var _loc3_:LayoutRasterizerData = var_40.getValue(var_705);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1221 = RoomObjectVariableEnum.const_831;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1221 = RoomObjectVariableEnum.const_933;
                           }
                           if(param2 != null)
                           {
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1847);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_705)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1022 = var_40.getValue(var_705);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_40.getValue(var_705);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc9_:IGraphicAsset = var_804.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1020.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1020.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_341.indexOf(_loc10_) >= 0 && var_496)
            {
               param1 = var_341.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_804.getAsset(var_497[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
