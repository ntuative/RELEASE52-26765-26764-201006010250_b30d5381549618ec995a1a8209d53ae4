package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_528:String = "room";
      ...
      private static const const_826:int = -3;
      ...
      private var var_790:RoomMessageHandler = null;
      
      private var var_789:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_326 = new Map();
         var_655 = new NumberBank(1000);
         var_1132 = new Map();
         var_327 = new Map();
         var_67 = new RoomObjectEventHandler(this);
         var_790 = new RoomMessageHandler(this);
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_326.length; _loc2_++)
         {
            _loc3_ = var_326.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_755) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_536) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_752) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_766) + 0.5;
      ...
      override public function dispose() : void
      {
         ...
         if(var_435 != null)
         {
            var_435.release(new IIDRoomObjectVisualizationFactory());
            var_435 = null;
         }
         if(var_43 != null)
         {
         ...
         if(var_789 != null)
         {
            var_789.release(new IIDRoomRendererFactory());
            var_789 = null;
         }
         ...
         if(var_326 != null)
         {
            ...
            {
               _loc2_ = var_326.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_698);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_847);
      ...
      private function method_3(param1:String) : String
      {
         if(var_12 != null)
         {
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.getModel() != null)
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_843) > 0)
               {
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_530,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.ROOM_OBJECT_REMOVED,var_119,var_120,param2,param3));
            }
         }
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_327.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_327.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_637,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_544,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_731,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_43 != null)
         {
            ...
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_255);
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_69);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_12.sessionDataManager = var_346;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         var _loc13_:String = method_3(_loc11_);
         if(_loc11_ == null)
         {
            _loc11_ = "";
         }
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_247,_loc12_,true);
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1003,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_866,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_862,getTimer());
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_573,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_27 == null || var_435 == null || var_43 == null || var_789 == null || _communication == null || _habboConfiguration == null || !var_2284)
         {
            return;
         }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1392,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_826,RoomObjectCategoryEnum.const_255);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1404);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1404);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_435;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_27 != null)
         {
            if(false)
            {
               var_27.events.addEventListener(RoomObjectMouseEvent.const_211,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_427,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_470,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_176,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_549,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_142,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_431,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_505,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_386,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectMoveEvent.const_407,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMoveEvent.const_389,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_296,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_378,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_328,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_308,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_432,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_860,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_500,roomObjectEventHandler);
               var_27.events.addEventListener(AvatarWalkWarpingWarningEvent.const_483,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_724) != 0)
         {
            return false;
         }
         if(var_67 != null)
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_327.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_283,param1,param2,param3,RoomObjectCategoryEnum.const_38));
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1045,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_992,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_402);
                     break;
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_542)
         {
            var_2284 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         var _loc11_:String = method_3(_loc9_);
         if(_loc9_ == null)
         {
            _loc9_ = "";
         }
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_247,_loc10_,false);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_283,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_285.events.addEventListener(AdEvent.const_442,showRoomAd);
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_326.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_758,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_789 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc11_:int = var_655.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_34:
            case RoomObjectCategoryEnum.const_32:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_247,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_402,param8);
               break;
            case RoomObjectCategoryEnum.const_38:
            ...
            case RoomObjectCategoryEnum.const_69:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_195,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_253,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_682,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_689,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_568,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
         ...
         {
            var_1132.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_867,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_655.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_825,RoomObjectCategoryEnum.const_255);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1633 - _loc12_.width / 2;
               _loc11_.y = var_1632 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_433,var_119,var_120,-1,RoomObjectCategoryEnum.const_240));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_67 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_299,const_528);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1404);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1633 - _loc6_.data.width / 2;
               _loc11_.y = var_1632 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_307,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_831,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_933,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_958,RoomObjectVariableEnum.const_307,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_326.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_326.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_542,onContentLoaderReady);
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_867);
               ...
               var_655.freeNumber(_loc10_ - 1);
               _loc13_ = var_1132.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_119,var_120,const_299,RoomObjectCategoryEnum.const_69,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1052,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_724,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_977,_loc13_,true);
            if(var_12 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_299,const_528,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_724,0,true);
         }
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_752,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_536,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_766,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_882,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_637,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_544,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_731,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_401,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_223);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_698,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_685,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_698,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_847,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_825,const_1172,RoomObjectCategoryEnum.const_255);
         _loc7_.createRoomObject(const_826,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_255);
         return _loc7_;
      }
