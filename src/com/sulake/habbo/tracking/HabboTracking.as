package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1150:CoreComponent;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            ...
            var_1150 = _loc5_;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1351,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1391,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1349,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_767,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1026,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1426);
               break;
            case HabboCommunicationEvent.const_693:
               trackLoginStep(HabboLoginTrackingStep.const_1334,String(_communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_192:
               trackLoginStep(HabboLoginTrackingStep.const_192);
               break;
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_335:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_151)
         {
            Component(var_151).events.addEventListener(HabboConfigurationEvent.const_168,onConfigurationLoaded);
            if(var_219 != null)
            {
               var_219.configuration = var_151;
            }
            if(var_218 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_285.events.addEventListener(AdEvent.const_442,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1654)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1419);
            var_1654 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1026,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_767,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_693,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_192,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_219,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_667,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_70,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_490,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_483:
         ...
         if(!disposed)
         {
            ...
            if(var_168)
            {
               if(true)
               {
                  ...
                  Component(var_168).events.removeEventListener(HabboFriendListTrackingEvent.const_335,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_483,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_151)
         {
            if(var_798 != null)
            {
               var_798.configure(var_151);
            }
            Component(var_151).events.removeEventListener(HabboConfigurationEvent.const_168,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_1009);
         if(var_1150 != null)
         {
            var_1150.events.removeEventListener(HabboLoginTrackingStep.const_1009,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_983 > -1 && _loc2_ < var_983)
         {
            ++var_1429;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1429);
         }
         if(var_983 > -1 && _loc2_ - var_983 > 15000)
         {
            ++var_1428;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1428);
         }
         var_983 = _loc2_;
         if(var_218 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_483,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_296,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_168).events.addEventListener(HabboFriendListTrackingEvent.const_335,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         logError(var_1150.getLastErrorMessage());
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_667)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1328);
         }
         else if(param1.type == HabboHotelViewEvent.const_490)
         {
