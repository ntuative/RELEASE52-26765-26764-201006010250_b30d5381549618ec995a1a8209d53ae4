package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1193 || var_1539 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1538 == 0 || _loc1_ - var_1538 > var_1539)
         {
            if(_connection != null)
            {
      ...
      {
         var_1193 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1539 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
