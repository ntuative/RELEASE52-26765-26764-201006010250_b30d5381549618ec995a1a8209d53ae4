package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private function windowManagerReceived(param1:IID, param2:IUnknown) : void
      {
         ...
         _window = var_1494.create("Logger::Output",HabboWindowType.const_113,WindowStyle.const_330,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_343 = var_1494.create("Logger::Output::Text",HabboWindowType.const_4,WindowStyle.const_330,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
