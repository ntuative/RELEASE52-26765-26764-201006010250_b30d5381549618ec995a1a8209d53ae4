package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_940 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_941 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         var_50 = IItemListWindow(var_54.findChildByName("chatline_list"));
         var_54.procedure = onWindow;
         var _loc1_:IWindow = var_54.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1622);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_940.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_941.clone());
         _loc4_.color = var_1360[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
