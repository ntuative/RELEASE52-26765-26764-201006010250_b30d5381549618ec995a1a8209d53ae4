package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_586,_data.flatId),var_54,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_744.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1305,_loc2_,var_445.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1081.isSelected,var_1082.isSelected,var_744.isSelected));
         }
         this.dispose();
      }
      ...
      {
         var_50 = IItemListWindow(var_54.findChildByName("list_cont"));
         ...
         var_744 = ICheckBoxWindow(var_54.findChildByName("kick_check"));
         var_1081 = ICheckBoxWindow(var_54.findChildByName("lock_check"));
         var_1082 = ICheckBoxWindow(var_54.findChildByName("changename_check"));
