   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_442,0,0,_loc4_,var_1607,var_944,var_945));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var_1608 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1367 = _loc2_.imageUrl;
         var_1607 = _loc2_.clickUrl;
         if(var_1367 != "" && var_1607 != "")
         {
            _loc3_ = var_1367;
            ...
            _loc4_ = new URLRequest(var_1367);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1368 = _loc2_.imageUrl;
         var_2218 = _loc2_.clickUrl;
         var_770 = getTimer();
         if(var_1368 != "")
         {
            _loc3_ = var_1368;
            ...
            var_242.start();
            _loc4_ = new URLRequest(var_1368);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_385,0,0,param1.bitmapData,var_2218));
            var_770 = getTimer();
         }
         else
         {
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1608 > 0 && var_1609 >= var_1608)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_770;
         if(_loc1_ > var_2217)
         {
            ++var_1609;
      ...
      {
         var_295 = param2 as IHabboCommunicationManager;
         if(var_295 == null)
         {
            return;
         }
         _connection = var_295.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
