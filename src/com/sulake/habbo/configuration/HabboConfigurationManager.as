package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1442:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_472 = getKey("url_prefix");
         if(var_472 != null && false)
         {
            setKey("client.fatal.error.url",var_472 + "/flash_client_error");
         }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1404);
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         if(getKey("local.environment") == "HabboNavigatorCom_ros_flat_controller_xml")
         {
            setKey("url.prefix",getKey("url.prefix.local"));
         }
         var_472 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_472.replace("http://","");
      ...
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_472);
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1442);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1442,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
