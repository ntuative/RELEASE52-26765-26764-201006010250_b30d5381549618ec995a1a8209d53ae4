package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1634:Number = 1.0;
      ...
      private var var_1635:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1635,var_1634,var_1636,_alphaMultiplier);
         var_1130 = generatePaletteMapForGrayscale(var_2278,var_2279);
      }
      
      public function get reds() : Array
      {
         return var_1130.getValue("reds") as Array;
      }
      ...
      {
         return var_1130.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1130.getValue("greens") as Array;
      }
      ...
      {
         return var_1130.getValue("alphas") as Array;
      }
