package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_773 >= 0 && var_183.length > var_773)
         {
            _loc2_ = var_183[var_773];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_183.length > param1)
         {
            _loc3_ = var_183[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!_loc2_ || !_loc2_.method_2)
         {
            return null;
         }
         var _loc3_:int = _loc2_.method_2.id;
         ...
         while(_loc5_ < var_207.length)
         {
            ...
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > var_207[_loc5_])
               {
                  ...
                  if(_loc8_ && _loc8_.method_2)
                  {
                     _loc4_.push(_loc8_.method_2.id);
                  }
                  else
                  {
                     _loc4_.push(_loc3_);
      ...
      {
         return var_183[var_773] as AvatarEditorGridPartItem;
      }
         ...
         while(_loc3_ < _palettes.length)
         {
            ...
            if(_loc4_)
            {
               ...
               else
               {
                  ...
                  if(_loc7_ && _loc7_.method_2)
                  {
                     _loc5_ = _loc7_.method_2.id;
                  }
               }
               _loc6_ = 0;
      ...
      public function stripClubColorsOverLevel(param1:int) : Boolean
      {
         ...
         if(!_loc6_ || _loc6_.method_2)
         {
            return false;
         }
         var _loc7_:int = _loc6_.method_2.id;
         var _loc8_:int = 0;
