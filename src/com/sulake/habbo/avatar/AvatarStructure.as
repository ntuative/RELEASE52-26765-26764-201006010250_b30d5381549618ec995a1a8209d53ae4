package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1503:PartOffsetData;
      
      private var var_860:AvatarActionManager;
      
      private var var_175:IAssetLibrary;
      
      private var var_861:IAssetLibrary;
      
      private var var_1886:AvatarRenderManager;
      
      private var var_299:FigureData;
      
      private var var_644:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_713:String;
      
      private var var_1504:AvatarStructureDownloadSet;
      
      private var var_1247:Array;
      
      private var var_712:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_415 = new PartSetsData();
         var_644 = new AnimationData();
         var_1504 = new AvatarStructureDownloadSet();
         var_712 = new AnimationManager();
         var_713 = param4;
         var_1503 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_860.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_860.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_299.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_860.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_712.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_415.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_415.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1357[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_860.getDefaultAction();
         var _loc9_:Array = var_415.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_712.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
               ...
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_644.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_415.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_415.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_713 + " ready to go!");
         if(var_713 == AvatarType.const_104)
         {
            var_415.getPartDefinition("ri").appendToFigure = true;
            var_415.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_713)
         {
            case AvatarType.const_104:
               ...
               var_1504.add(new AvatarStructureDownload(var_175,_loc5_,var_299));
               break;
            case AvatarType.PET:
         }
         var_1504.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_712.getAnimation(param1);
      }
      ...
      {
         var_860 = new AvatarActionManager(var_175,var_713);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1247 = var_299.getMandatorySetTypeIds();
         return var_1247;
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_861.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_861.getAssetByName("dance" + _loc1_).content as XML;
            var_712.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_861.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_861.getAssetByName("fx" + _loc1_).content as XML;
            var_712.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         var_1503.loadOffsets(var_861);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_860.sortActions(param1);
      }
   }
}
