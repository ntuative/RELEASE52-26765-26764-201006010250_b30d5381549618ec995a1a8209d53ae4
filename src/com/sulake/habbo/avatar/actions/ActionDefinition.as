package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1502 = new Dictionary();
         super();
         _id = String(param1.@id);
         var_36 = String(param1.@state);
         var_1878 = parseInt(param1.@precedence);
         var_1879 = String(param1.@activepartset);
         var_1881 = String(param1.@assetpartdefinition);
         var_1883 = String(param1.@lay);
         var_615 = String(param1.@geometrytype);
         var_1885 = Boolean(parseInt(param1.@main));
         var_1884 = Boolean(parseInt(param1.@var_316));
         var_1882 = Boolean(parseInt(param1.@animation));
      ...
      {
         return var_1246.concat(getTypePrevents(param1));
      }
