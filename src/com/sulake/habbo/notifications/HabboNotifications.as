package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1107:String = "badges";
      
      private static const const_1104:String = "pet_inventory";
      
      private static const const_1106:String = "pixelbalance";
      
      private static const const_1105:String = "credits";
      
      private static const const_1108:String = "inventory";
      
      private static const const_1109:String = "friendlist";
      
      private static const const_1103:String = "selectfurni";
      
      private static const const_1110:String = "selectbadge";
      ...
      private var var_416:HabboNotificationViewManager;
      
      private var var_715:ClubEndingNotification;
      ...
      private var var_716:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_862);
         }
         var _loc6_:Map = var_862["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_716 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1352);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1902)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1031);
            var_1902 = true;
      ...
      {
         if(param1 != null && this.var_416 != null)
         {
            var_416.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_1031,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_600.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_55);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_865,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_189 || param2.type == WindowEvent.const_683)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_416.isSpaceAvailable() && false)
         {
            var_416.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_600.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_55);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = var_346.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_82)
               {
                  _loc9_ = var_346.getWallItemData(_loc8_.furniClassId);
               }
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1204,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_600.createAvatarImage(param2,AvatarScaleType.const_55);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1280)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_715 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_601.events.addEventListener(HabboToolbarEvent.const_89,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_346.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_978);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_978);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_89)
         {
            ...
            var_416 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_862["styles"],var_862["view"],var_601);
            ...
            registerUpdateReceiver(var_416,1);
            registerUpdateReceiver(this,2);
            var_346.events.addEventListener(BadgeImageReadyEvent.const_141,onBadgeImage);
