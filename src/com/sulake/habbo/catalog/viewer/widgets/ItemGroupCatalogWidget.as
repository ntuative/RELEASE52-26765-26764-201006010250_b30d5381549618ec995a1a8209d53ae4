package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_631[var_1093] as Array;
      ...
      {
         var _loc2_:Offer = var_631[var_1093][var_2158];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_398 || _loc1_.pricingModel == Offer.const_502)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_82 || _loc3_.productType == ProductTypeEnum.const_84)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1094.indexOf(_loc5_) == -1)
                        {
                           var_1094.push(_loc5_);
                           var_631.push(new Array());
                        }
                        _loc6_ = var_1094.indexOf(_loc5_);
                        (var_631[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_631)
         {
            if(var_2158 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2158] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1093 = var_976.getGridItemIndex(param1.view);
