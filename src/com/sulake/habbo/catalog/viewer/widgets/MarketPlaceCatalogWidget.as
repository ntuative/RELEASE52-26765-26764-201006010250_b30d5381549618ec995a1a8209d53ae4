package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_890:MarketPlaceOfferData;
      
      private const const_1463:int = 1;
      
      private const const_1732:int = 40;
      
      private var var_524:IWindowContainer;
      
      private const const_1462:int = 2;
      ...
      private const const_1731:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_524)
         {
            ...
            var_524 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_524)
         {
            return;
         ...
         updateStatusDisplay(const_1462,_loc2_.length);
         if(!var_432)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_581)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_524 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_524.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1463);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_891 >= var_581.length)
            {
               return true;
            }
            addListItem(var_581.getWithIndex(var_891));
            ++var_891;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_890.offerId);
            }
            return;
         }
