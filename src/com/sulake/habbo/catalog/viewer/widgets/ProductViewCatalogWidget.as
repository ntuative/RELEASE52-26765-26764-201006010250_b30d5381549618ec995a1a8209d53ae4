package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1345:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1408.text = "${" + _loc3_.name + "}";
            var_1407.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1408.text = "${" + _loc2_.localizationId + "}";
            var_1407.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_451:
                  _loc4_ = var_1344.clone();
                  if(var_628 != null)
                  {
                     var_628.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_628,var_1345,var_1198);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_232:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_291,AvatarAction.const_377);
                              _loc13_.appendAction(AvatarAction.const_397,_loc6_.productClassId);
      ...
      {
         var_1408 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1407 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1587 = new Point(var_85.x,var_85.y);
         var_628 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1345 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_628 == null)
         {
         ...
         var_1344 = _loc2_.content as BitmapData;
