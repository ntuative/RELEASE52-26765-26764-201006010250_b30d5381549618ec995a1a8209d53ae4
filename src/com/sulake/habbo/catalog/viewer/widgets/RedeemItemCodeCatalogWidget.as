package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1039:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1039 != null)
         {
            var_1039.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1040 != null)
         {
            var_1040.removeEventListener(WindowKeyboardEvent.const_154,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1039 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1039 != null)
         {
            var_1039.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1040 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1040 != null)
         {
            var_1040.addEventListener(WindowKeyboardEvent.const_154,windowKeyEventProcessor);
         }
      }
