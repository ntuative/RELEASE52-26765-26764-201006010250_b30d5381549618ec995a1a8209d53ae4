      ...
      private function onClickLink(param1:WindowMouseEvent) : void
      {
         ...
         switch(page.layoutCode)
         {
               ...
               switch(_loc4_)
               {
                  ...
                  case "ctlg_txt7":
                     if(IWindow(param1.target).caption != "")
                     {
                        ...
                        {
                           if(false && "HabboNavigatorCom_ros_flat_controller_xml" == _loc3_.getKey("client.credits.embed.enabled"))
                           {
            ...
            case "club1":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openCatalogPage(CatalogPageName.const_237,true);
               }
               break;
            case "club_buy":
               switch(_loc4_)
