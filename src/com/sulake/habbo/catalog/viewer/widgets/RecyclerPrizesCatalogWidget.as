package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_698.length)
         {
            createLevelItem(var_698[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_698 = recycler.getPrizeTable();
         if(var_698 == null)
         {
            return;
         }
         ...
         populateItemGrid();
         if(false && var_698[0].prizes.length > 0)
         {
            select(var_698[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1197) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1198) as IWindowContainer;
