package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2395:String = "magic.pixels";
      
      private var var_2396:String = "catalog.page.club";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","false") == "HabboNavigatorCom_ros_flat_controller_xml";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2396,true);
      }
