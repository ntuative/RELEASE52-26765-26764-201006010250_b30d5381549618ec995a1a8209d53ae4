package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_418:ClubBuyController;
      ...
      private var var_1905:GiftWrappingConfiguration;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1907 && var_511 != null)
         {
            var_511.playSound(HabboSoundTypesEnum.const_913);
         }
         var_1907 = false;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_418 == null)
         {
            var_418 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_100:
               var_1255 = param1.session.isPrivateRoom;
               if(var_83 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "HabboNavigatorCom_ros_flat_controller_xml" == var_151.getKey("client.credits.embed.enabled"))
            {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1905 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_863)
         {
            if(!var_346.loadProductData(this))
            {
               return;
            }
            init();
         ...
         {
            var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1034.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createClubGiftController() : void
      {
         if(var_1034 == null)
         {
            var_1034 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_197 == null)
            {
               var_197 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_197.showOffer(this,param1,param2,param3,_loc7_);
         ...
         {
            var_418.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(var_1033 != "")
         {
            var_419.openPage(var_1033);
            var_1033 = "";
         }
         else
         {
            var_419.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1906 && var_511 != null)
         {
            var_511.playSound(HabboSoundTypesEnum.const_836);
         }
         var_1906 = false;
      }
