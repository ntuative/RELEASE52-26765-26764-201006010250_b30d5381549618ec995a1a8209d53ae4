package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2276:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1484,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_2020 || param1.furniTypeId != var_2021)
         {
            return;
         }
         var_2276 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1605,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_2260 = _loc3_.creditsWaiting;
         var_212 = new Map();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_197)
         {
            var_197 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_197.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_2273,var_2274,var_1904,var_2275);
      }
