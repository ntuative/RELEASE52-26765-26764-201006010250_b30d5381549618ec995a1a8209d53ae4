package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1069:Number = 25;
      
      private static const const_1146:int = 50;
      ...
      private var var_1074:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            var_533.splice(_loc3_,1);
         }
         var_533.push(param1.name);
         var_534.push(param2);
      ...
      {
         return var_534[var_533.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1074.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_308.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_308.splice(var_308.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1074.getIconLoc(param1.iconId);
      ...
      {
         return var_533[var_534.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_308[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_798 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_798 || param1.desktop.height - param1.y < const_1146;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_533[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  ...
                  {
                     repositionWindow(var_619[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
