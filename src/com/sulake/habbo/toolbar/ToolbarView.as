package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_199 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_996,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1054 = String(_loc7_.relocate_by_drag.@state) == "HabboNavigatorCom_ros_flat_controller_xml";
         if(var_1054)
         {
         ...
         var_1274 = _loc7_.toolbar.@margin_bottom;
         ...
         createGroupsFromXmlList(_loc8_,var_275,param1,param2,_window,var_264);
         createGroupsFromXmlList(_loc9_,var_612,param1,param2,var_199,var_264);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_133,var_522,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1532,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1274) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1532,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1274) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_612.length)
         {
            _loc3_ = var_612[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_133,var_522);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_612.length)
         {
            _loc2_ = var_612[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_133,var_522);
         }
      }
