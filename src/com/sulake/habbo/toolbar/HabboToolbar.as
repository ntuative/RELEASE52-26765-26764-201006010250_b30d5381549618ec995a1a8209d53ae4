package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_295.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_144,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_907,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_162,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_193,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_49,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_510,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_742,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1038,onHideWindowEvent);
         var_36 = true;
