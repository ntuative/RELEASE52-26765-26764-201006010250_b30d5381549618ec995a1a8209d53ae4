package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      {
         if(var_1172 == true || var_688 == 0)
         {
            if(false)
            {
               ++var_54;
               if(var_54 >= var_817.length)
               {
                  var_54 = 0;
                  ++var_688;
               }
      ...
      {
         return var_1172 == false && var_688 == 1 && var_1251 != var_36;
      }
