package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_834:uint = 4;
      ...
      protected var var_2388:String = "";
      
      protected var var_16:IContext = null;
      
      protected var var_1747:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_981 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_981);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1144 & const_834)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_436 + "]";
      }
