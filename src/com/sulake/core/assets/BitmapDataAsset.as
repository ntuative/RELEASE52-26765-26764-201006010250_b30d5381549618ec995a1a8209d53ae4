package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements IAsset
   {
      ...
      protected static var var_667:uint = 0;
      ...
      private var var_1170:AssetTypeDeclaration;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  var_1124 = _loc4_ == "1" || _loc4_ == "HabboNavigatorCom_ros_flat_controller_xml";
                  break;
               case "flipV":
                  var_1125 = _loc4_ == "1" || _loc4_ == "HabboNavigatorCom_ros_flat_controller_xml";
                  break;
            }
            _loc2_++;
         }
