package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_625:uint = 0;
      
      public static const const_716:String = "AssetLibraryReady";
      
      public static const const_1403:String = "AssetLibraryUnloaded";
      
      public static const const_423:String = "AssetLibraryLoaded";
      
      public static const const_1342:String = "AssetLibraryLoadError";
       
      
      private var var_540:XML;
      ...
      private var var_539:Boolean = true;
      
      private var var_365:Class;
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_747)
         {
            delete var_747[_loc1_];
         }
         if(var_14 != null)
         {
            var_14.dispose();
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_540 = _loc2_.manifest.copy();
         var_365 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_539)
         {
            AssetLibrary.fetchLibraryContents(this,var_540,var_365);
         }
         var_310 = true;
         dispatchEvent(new Event(AssetLibrary.const_423));
         dispatchEvent(new Event(AssetLibrary.const_716));
         if(var_539)
         {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1084.splice(var_1084.indexOf(this),1);
            --var_625;
            var_443 = null;
            var_747 = null;
            var_138 = null;
      ...
      {
         return param1 < var_366.length ? getAssetByName(var_366[param1]) : null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_540.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_365[param1]);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in var_138)
            {
               if(var_138[_loc2_] == param1)
               {
                  var_366.splice(var_366.indexOf(_loc2_),1);
      ...
      {
         return var_365 != null ? false : false;
      }
   }
}
