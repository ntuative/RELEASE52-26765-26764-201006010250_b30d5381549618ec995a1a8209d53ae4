   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_363)
         {
            ...
            if(var_363)
            {
               var_363.addEventListener(WindowEvent.const_261,scrollBarEventProc);
               var_363.addEventListener(WindowEvent.const_209,scrollBarEventProc);
            }
         }
         return var_363;
      }
      ...
      override public function dispose() : void
      {
         if(var_363)
         {
            var_363.removeEventListener(WindowEvent.const_261,scrollBarEventProc);
            var_363.removeEventListener(WindowEvent.const_209,scrollBarEventProc);
            var_363 = null;
         }
         if(var_899)
         {
