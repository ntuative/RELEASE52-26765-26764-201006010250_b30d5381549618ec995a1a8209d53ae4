package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1055:String = "spacing";
      
      protected static const const_1434:Boolean = false;
      ...
      protected static const const_1435:Boolean = true;
      ...
      protected var var_557:Boolean = false;
      
      protected var var_2386:Number = 0.0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_166 = var_660 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_304,WindowStyle.const_330,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_48,containerEventHandler);
         _container.addEventListener(WindowEvent.const_400,containerEventHandler);
         _container.addEventListener(WindowEvent.const_293,containerEventHandler);
         _container.addEventListener(WindowEvent.const_381,containerEventHandler);
      ...
      {
         return new Rectangle(var_556 * maxScrollH,var_555 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_400,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_293,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_381,containerEventHandler);
         super.dispose();
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_556 = param1;
            _container.x = -var_556 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1055,_spacing,PropertyStruct.const_66,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1054,var_794,PropertyStruct.const_61,var_794 != const_1435));
         _loc1_.push(new PropertyStruct(const_1056,var_557,PropertyStruct.const_61,var_557 != const_1434));
         _loc1_.push(new PropertyStruct(const_1057,var_1138,PropertyStruct.const_61,var_1138 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1057:
                  ...
                  break;
               case const_1054:
                  var_794 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_387,param1);
            }
            else
            {
