package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1101:String = "content";
      
      private static const const_1102:String = "selector";
      ...
      protected var var_1641:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1641 == null)
         {
            var_1641 = findChildByTag(TabContextController.const_1101) as IWindowContainer;
         }
         return var_1641;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_977 == null)
         {
            var_977 = findChildByTag(TabContextController.const_1102) as ITabSelectorWindow;
            if(var_977 != null)
            {
               var_977.procedure = selectorEventProc;
            }
         }
         return var_977;
      }
      ...
      {
         return !!var_863 ? selector.iterator : null;
      }
