package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1155:String = "increment";
      
      private static const const_520:String = "slider_bar";
      
      private static const const_1156:String = "decrement";
      
      private static const const_812:String = "slider_track";
      ...
      protected var var_796:Number = 0.1;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_520:
      ...
      {
         return findChildByName(ScrollbarController.const_812) as WindowController;
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_520) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_930 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_930 != null)
         {
            _loc1_ = findParentByName(var_930) as IScrollableWindow;
            if(_loc1_ == null && var_9 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_9).findChildByName(var_930) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1155)
            {
               if(var_21)
               {
                  var_633 = true;
            ...
            else if(param2.name == ScrollbarController.const_1156)
            {
               if(var_21)
               {
                  var_633 = true;
            ...
            else if(param2.name == ScrollbarController.const_812)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_520).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_871)
         {
