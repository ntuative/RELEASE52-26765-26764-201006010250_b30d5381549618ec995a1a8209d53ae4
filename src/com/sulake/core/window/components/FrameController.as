package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_804:String = "margin_top";
      
      private static const const_1151:String = "_HEADER";
      
      private static const const_805:String = "margin_right";
      
      private static const const_1152:String = "_SCALER";
      
      private static const const_1094:String = "_TITLE";
      
      private static const const_1153:String = "_CONTENT";
      
      private static const const_806:String = "margin_left";
      
      private static const const_807:String = "margin_bottom";
      ...
      private var var_1346:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_806,_loc3_.left,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_804,_loc3_.top,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_805,0 - _loc3_.right,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_807,0 - _loc3_.bottom,PropertyStruct.const_66,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1346 == null)
         {
            var_1346 = findChildByTag(const_1151) as IHeaderWindow;
            if(!var_1346)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1094) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1152) as IScalerWindow;
      }
      ...
      {
         return content != null && var_665 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1153) as IWindowContainer;
            if(!var_20)
            {
