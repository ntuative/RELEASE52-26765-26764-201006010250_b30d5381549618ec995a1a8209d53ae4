package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_441 = _loc13_.blend;
            var_559 = _loc13_.treshold;
            if(var_660 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_560 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_131,WindowParam.const_153);
         var _loc2_:* = !testParamFlag(WindowParam.const_143,WindowParam.const_150);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_322)
               {
                  _loc3_.x += _loc4_;
               }
      ...
      {
         var_660 = param1;
         var_560 = !!var_660 ? uint(var_560 | var_1416) : uint(var_560 & 16777215);
      ...
      {
         var_559 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1227:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1321:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_495:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_285:
               _loc2_ = "null";
         }
         if(_loc2_ == WindowEvent.const_191)
         {
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_80 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_498,this,null));
         }
      }
      ...
      {
         var_441 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_841);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1106 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_352,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_559);
      }
      
      public function set color(param1:uint) : void
      {
         var_1416 = param1 & 4278190080;
         var_560 = !!var_660 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_78);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_938;
                  if(testParamFlag(WindowParam.const_333))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_171:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_495,this,null));
                     if(testParamFlag(WindowParam.const_164,WindowParam.const_153))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_180,WindowParam.const_150))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                     {
                        _loc8_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_387))
                        {
                           var_9.width += 0 - 0;
                        }
                        ...
                        _param = _loc8_;
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_285,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_403:
                  var_16.invalidate(this,var_8.union(var_57),WindowRedrawFlag.const_384);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_850,this,null));
                     if(var_9 != null)
                     {
               ...
               case WindowNotifyEvent.const_354:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_647,this,null));
                     if(var_9 != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_488:
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_1044);
                  break;
               case WindowNotifyEvent.const_498:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_422:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_384);
                     }
                  }
                  else if(_param & 0)
                  {
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_559);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_354;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_744,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1106 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_36 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_488,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_476)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_493)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_974,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_641,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_65,true);
         _loc1_.type = WindowNotifyEvent.const_1335;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_166 && var_559 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1611,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1611,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1370,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            else
            {
               ...
               var_319.width = 0;
               var_319.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_980,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,_param,var_16,var_8,null,var_664,properties,var_661.concat(),_id) as WindowController;
         ...
         _loc2_.var_560 = var_560;
         _loc2_.var_1416 = var_1416;
         _loc2_.var_1143 = var_1143;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_548;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_486;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_36 == WindowState.const_391)
         {
            return true;
         }
