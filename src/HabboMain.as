package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc14_:Number = 1 - const_24 + var_28.getNumberOfFilesLoaded() / _loc13_ * const_24;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_894,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_28);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_894,error);
            Core.dispose();
         }
      }
