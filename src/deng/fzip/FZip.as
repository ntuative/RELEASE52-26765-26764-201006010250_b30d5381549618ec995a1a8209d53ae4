package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_520 = new FZipFile(this,charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  var_95 = parseIdle;
      ...
      {
         if(var_520.parse(param1))
         {
            var_48.push(var_520);
            if(false)
            {
               var_131["null"] = var_520;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1189,var_520));
            var_520 = null;
            if(var_95 != parseIdle)
            {
               var_95 = parseSignature;
